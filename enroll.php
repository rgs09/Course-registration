...
$email=$_POST['email'];
$ret=mysqli_query($bd, "insert into courseenrolls(studentRegno,pincode,session,department,level,course,semester,contact,email) values('$studentregno','$pincode','$session','$dept','$level','$course','$sem','$contact','$email')");
if($ret)
{
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="Pincode" name="Pincode" readonly value="<?php echo htmlentities($row['pincode']);?>" readonly />
  </div>   

  <div class="form-group">
    <label for="contact">Contact No.  </label>
    <input type="text" class="form-control" id="contact" name="contact" readonly value="<?php echo htmlentities($row['contact']);?>" readonly />
  </div> 

  <div class="form-group">
    <label for="email">Email  </label>
    <input type="text" class="form-control" id="email" name="email" readonly value="<?php echo htmlentities($row['email']);?>" readonly />
  </div> 
