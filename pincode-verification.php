...
<head>
    ...
    <title>Secret Verification</title>
 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Date of Birth Verification</h1>
                    </div>
                </div>
                <div class="row" >
...
<font color="red" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
   ...
   <div class="form-group">
    <label for="pincode">Enter Date of Birth</label>
    <input type="password" class="form-control" id="pincode" name="pincode" placeholder="Date of Birth" required />
  </div>
