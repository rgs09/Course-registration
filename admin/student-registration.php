...
$email = $_POST['email'];
$ret=mysqli_query($bd, "insert into students(studentName,StudentRegno,password,pincode,contact,email) values('$studentname','$studentregno','$password','$pincode','$contact','$email')");
if($ret)
{
...
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="pincode" name="pincode" placeholder="DDMMYYYY Format" required />
  </div>   
  
<div class="form-group">
    <label for="contact">Contact No.  </label>
    <input type="text" class="form-control" id="contact" name="contact" placeholder="Enter Phone No." required />
  </div>   
